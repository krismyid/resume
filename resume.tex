...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    ...
    \item Strategically led modernization initiative for enterprise clients, migrating legacy PHP 5.7 / MySQL 5.7 stacks to modern architectures and replacing legacy Nginx WAF with Chaitin SafeLine WAF
