...
\subsection{Cloud Engineering Trainer (Freelance Coach)}
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    ...
    \item Program "Fresh Graduate Academy (FGA) 2024" as trainer, delivering material about Cloud Implementation using AWS technologies
\end{itemize}

% Professional Experience
\section{Professional Experience}

\subsection{Senior DevOps Engineer}
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    ...
    \item Deployed nationwide government talent pool project on AWS in record 3 days, including Landing Zone, EKS, EC2, IAM privileges, AWS Backup, S3, supporting infrastructure, GitHub Actions CI/CD, and workflow automation using modular Terraform
    \item Implemented standardized AWS Secure Landing Zone aligned with Malaysia Secure LZ reference architecture for Malaysian public sector projects using Terraform IaC and GitHub Actions CI/CD
    \item Implemented Agentic AI practices and tooling to empower junior engineers, significantly improving team productivity
    \item Deployed self-hosted AI models for cost-effective LLM operations, optimizing token economy and reducing operational costs
    \item Developed internal tooling: AWS resource inventory reporter, New Relic usage analytics, MinIO-S3 sync utility, and other automation tools
    \item Strategically led modernization initiative for enterprise clients, migrating legacy PHP 7.2 / MySQL 5.7 stacks to modern architectures and replacing legacy Nginx WAF with Chaitin SafeLine WAF
    \item Implemented Ansible automation for super-legacy projects, creating standardized, rigid deployment templates to ensure consistent and reliable application deployments
